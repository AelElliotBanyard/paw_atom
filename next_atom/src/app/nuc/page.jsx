    ...
    <div className="flex flex-col justify-center items-center">
      ...
      <div className="flex flex-col">
        <div className="flex flex-col justify-center items-center gap-10 bg-white p-5">
          <p className="text-3xl md:text-5xl text-center text-black">Unteschied zu Normalen Waffen</p>
        ...
        <div className="flex flex-col justify-center items-center gap-10 bg-white p-5">
          <p className="text-3xl md:text-5xl text-center text-black">Ihre Typen und deren Zwecke</p>
