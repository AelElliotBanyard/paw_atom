        ...
        <div className="bg-white text-black flex flex-col justify-center items-center gap-10 p-5">
          ...
          <div className="grid md:grid-cols-2 grid-cols-1 gap-8 text-white ">
            <p className="bg-black rounded p-4 bg-opacity-80 h-full first-letter:text-5xl first-letter:float-left shadow-[#CB5329]  shadow-lg">
              ...
              zu zerstören, und sie stellt eine unmittelbare Gefahr für Menschen
              dar, da sie sie gegen Wände oder Objekte schleudern kann. Darüber
            ...
            <p className="bg-black rounded p-4 bg-opacity-80 h-full first-letter:text-5xl first-letter:float-left shadow-[#CB5329] shadow-lg">
              ...
              für Krebs erhöht. Zusätzlich besitzt sie die Fähigkeit,
        ...
        <div className="bg-white text-black flex flex-col justify-center items-center gap-10 p-5">
          ...
          <div className="grid md:grid-cols-2 grid-cols-1 gap-8 text-white ">
            <p className="bg-black rounded p-4 bg-opacity-80 h-full first-letter:text-5xl first-letter:float-left shadow-[#CB5329] shadow-lg">
              ...
              dies dazu, ihre nukleare Überlegenheit aufrechtzuerhalten und zu
            ...
            <p className="bg-black rounded p-4 bg-opacity-80 h-full first-letter:text-5xl first-letter:float-left shadow-[#CB5329] shadow-lg">
              ...
              Treaty, CTBT) wurden alle von diesem verborgenen Verlangen
              geleitet. Die Frage der nuklearen Verbreitung gegenüber der
            ...
            <p className="bg-black rounded p-4 bg-opacity-80 h-full first-letter:text-5xl first-letter:float-left shadow-[#CB5329] shadow-lg">
              ...
              Schaffung eines Gleichgewichts des Schreckens in den
